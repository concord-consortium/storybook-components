...
export const Icons = {
  OneUp, TwoUp, FourUp, Caret,
  Copy, CopyOnly, DeleteWorkspace, DragTile, DrawTile,
  DropdownCaret, Edit, EditWorkspaceName, GoToWorkspace,
  GraphTile, ImageTile, LearningLogDropdown, LinkedTile,
  New, NotShare, PageLeftRight, PageUpDown, Publish,
  Published, PublishedHover, PublishHover, Refresh,
  SelectionTile, Share, StarWorkspace, StickyNote, Support,
  TableTile, TeacherStudent, TextTile
};
